...
namespace Webpay.Integration.CSharp.Test.Hosted.Helper
{
    ...
    public class HostedXmlBuilderTest
    {
        ...
        public void TestXmlWithIndividualCustomer()
        {
            ...
            Assert.True(_xml.Contains("<customer><ssn>666666</ssn><firstname>Julius</firstname><lastname>Caesar</lastname><initials>JS</initials><email>test@svea.com</email><phone>999999</phone><address>Gatan</address><zip>9999</zip><housenumber>23</housenumber><address2>c/o Eriksson</address2><city>Stan</city><country>SE</country></customer>"));
        ...
        public void TestXmlWithCompanyCustomer()
        {
            ...
            Assert.True(_xml.Contains("<customer><ssn>666666</ssn><firstname>TestCompagniet</firstname><email>test@svea.com</email><phone>999999</phone><address>Gatan</address><zip>9999</zip><housenumber>23</housenumber><address2>c/o Eriksson</address2><city>Stan</city><country>SE</country></customer>"));
            Assert.True(_xml.Contains("<ipaddress>123.123.123.123</ipaddress>"));
        }
