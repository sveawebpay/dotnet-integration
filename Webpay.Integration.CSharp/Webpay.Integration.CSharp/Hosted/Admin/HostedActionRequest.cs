...
namespace Webpay.Integration.CSharp.Hosted.Admin
{
    public class HostedActionRequest
    {
        ...
        public T DoRequest<T>()
        {
            ...
            if (typeof(T) == typeof(ReplaceOrderRowResponse))
            {
                var hostedAdminResponse = HostedAdminRequest.HostedAdminCall(GetEndPointBase(), PrepareRequest());
                return (T)(object)hostedAdminResponse.To(ReplaceOrderRow.Response);
            }
            ...
            if (typeof(T) == typeof(UpdateMetadataResponse))
            {
                var hostedAdminResponse = HostedAdminRequest.HostedAdminCall(GetEndPointBase(), PrepareRequest());
                return (T)(object)hostedAdminResponse.To(UpdateMetadata.Response);
            }
            //Query
