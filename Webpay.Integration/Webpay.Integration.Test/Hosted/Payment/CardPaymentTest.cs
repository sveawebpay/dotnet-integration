...
public class CardPaymentTest
{
    ...
    public void TestBuildCardPayment()
    {
        ...
        var amount = xml.Substring(xml.IndexOf("<amount>", StringComparison.InvariantCulture) + 8, expectedAmount.Length);
        var vat = xml.Substring(xml.IndexOf("<vat>", StringComparison.InvariantCulture) + 5, expectedVat.Length);
    ...
    public void TestBuildCardPaymentWithCustomer()
    {
        ...
        var customer = xml.Substring(startIndex, endIndex - startIndex);
